...
<main class="main">
    ...
    <section id="about" class="about section">
      <div class="container section-title" data-aos="fade-up">
        <div class="row">
            <h2>Cari Teknisi Komputer Terdekat</h2>

            <div class="col-lg-4 mb-3">
                <label for="locationSearch" class="form-label">Lokasi</label>
                <input type="text" id="locationSearch" class="form-control" placeholder="Masukkan lokasi...">
            </div>
            <div class="col-lg-2 mb-3">
                <label for="radiusKm" class="form-label">Radius (km)</label>
                <input type="number" id="radiusKm" class="form-control" placeholder="Radius km" value="10">
            </div>
            <div class="col-lg-2 mb-3 d-flex align-items-end">
                <button class="btn btn-primary w-100" onclick="searchLocation()">Cari Lokasi</button>
            </div>
            <div class="col-lg-2 mb-3 d-flex align-items-end">
                <button class="btn btn-outline-secondary w-100" onclick="useMyLocation()">Gunakan Lokasi Saya</button>
            </div>
        ...
        .then(techs => {
            ...
            techs.forEach(tech => {
                ...
                const popupContent = `
                    ...
                    <a href="/teknisi/${tech.id}/pesan" class="btn btn-warning btn-sm mt-2">Pesan Teknisi</a>
                `;
